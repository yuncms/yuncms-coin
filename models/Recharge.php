...
class Recharge extends ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('coin', 'ID'),
            'payment_id' => Yii::t('coin', 'Payment Id'),
            'user_id' => Yii::t('coin', 'User ID'),
            'name' => Yii::t('coin', 'Name'),
            'gateway' => Yii::t('coin', 'Gateway'),
            'currency' => Yii::t('coin', 'Currency'),
            'money' => Yii::t('coin', 'Money'),
            'trade_state' => Yii::t('coin', 'Trade State'),
            'trade_type' => Yii::t('coin', 'Trade Type'),
            'created_at' => Yii::t('coin', 'Created At'),
            'updated_at' => Yii::t('coin', 'Updated At'),
        ];
    }
